...
difficulty: 중급
status: growing
prerequisites: ["[[20 위키/01 개념/Java/인터페이스]]", "[[20 위키/01 개념/Java/중첩 클래스]]", "[[20 위키/01 개념/Java/Set 구현체와 중복 판단]]"]
related: ["[[20 위키/01 개념/Java/IO와 NIO 파일 처리]]", "[[20 위키/06 나만의 요약/Java/Java API 선언문 읽기]]"]
...
메서드 참조·람다·익명 클래스의 변환 과정은 [[20 위키/06 나만의 요약/Java/Java API 선언문 읽기]]에 따로 보존한다.
...
- 객체 직렬화의 전체 흐름은 [[20 위키/01 개념/Java/IO와 NIO 파일 처리#객체 직렬화와 역직렬화]]에서 확인한다.
